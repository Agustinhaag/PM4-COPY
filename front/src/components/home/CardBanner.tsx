  ...
  return (
    ...
    >
      <div className="info-proyecto flex flex-col justify-center h-5/6 w-11/12 mx-auto p-2.5 gap-5 text-custom-white">
        ...
        <div>
        <Link href={PATHROUTES.CART} className="border border-custom-blue font-medium py-2 px-5 rounded-2xl bg-none text-custom-blue text-xs sm:text-sm hover:bg-custom-blue hover:text-custom-white">COMPRAR</Link>
        </div>
      </div>
    </div>
  );
